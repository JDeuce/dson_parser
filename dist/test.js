...
/***/ function(module, exports, __webpack_require__) {
	...
	var cases = [['such "foo" is "bar", "doge" is "shibe" wow', '{"foo":"bar","doge":"shibe"}'], ['such "foo" is such "shiba" is "inu", "doge" is yes wow wow', '{"foo":{"shiba":"inu","doge":true}}'], ['such "foo" is so "bar" also "baz" and "fizzbuzz" many wow', '{"foo":["bar","baz","fizzbuzz"]}'], ['such "foo" is 42, "bar" is 42very3 wow', '{"foo":34,"bar":17408}']];

	function test_parse(i) {
	  var c = cases[i];
	  var r = JSON.stringify(_entry2.default.parse(c[0]));
	  _assert2.default.equal(r, c[1]);
	}

	function test_stringify(i) {
	  var c = cases[i];
	  var r = _entry2.default.stringify(JSON.parse(c[1]));
	  _assert2.default.equal(r, c[0]);
	}

	describe('DSON', function () {
	  var test_case = void 0;
	  ...
	  describe('stringify', function () {
	    for (test_case = 0; test_case < cases.length; test_case++) {
	      ...
	      var r = _entry2.default.stringify({});
	      _assert2.default.equal(r, "such wow");
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dson_json = __webpack_require__(2);

	var _dson_json2 = _interopRequireDefault(_dson_json);

	var _json_dson = __webpack_require__(3);

	var _json_dson2 = _interopRequireDefault(_json_dson);
	...
	var DSON = {
	  parse: _dson_json2.default.parse,
	  stringify: function stringify(json) {
	    if (typeof json !== 'string') json = JSON.stringify(json);
	    return _json_dson2.default.parse(json);
	  }
	};

	exports.default = DSON;

	// Export to browser global namespace

	if (typeof window !== 'undefined') window.DSON = DSON;
	...
	module.exports = (function() {
	  ...
	  function peg$parse(input) {
	    var options = arguments.length > 1 ? arguments[1] : {},
	        ...
	        peg$startRuleFunctions = { DSON_text: peg$parseDSON_text },
	        peg$startRuleFunction  = peg$parseDSON_text,

	        peg$c0 = function(value) { return value; },
	        peg$c1 = "so",
	        peg$c2 = { type: "literal", value: "so", description: "\"so\"" },
	        peg$c3 = "many",
	        peg$c4 = { type: "literal", value: "many", description: "\"many\"" },
	        peg$c5 = "such",
	        peg$c6 = { type: "literal", value: "such", description: "\"such\"" },
	        peg$c7 = "wow",
	        peg$c8 = { type: "literal", value: "wow", description: "\"wow\"" },
	        peg$c9 = "is",
	        peg$c10 = { type: "literal", value: "is", description: "\"is\"" },
	        peg$c11 = "and",
	        peg$c12 = { type: "literal", value: "and", description: "\"and\"" },
	        peg$c13 = "also",
	        peg$c14 = { type: "literal", value: "also", description: "\"also\"" },
	        peg$c15 = ",",
	        ...
	        peg$c26 = "no",
	        peg$c27 = { type: "literal", value: "no", description: "\"no\"" },
	        peg$c28 = function() { return false; },
	        peg$c29 = "empty",
	        peg$c30 = { type: "literal", value: "empty", description: "\"empty\"" },
	        peg$c31 = function() { return null;  },
	        peg$c32 = "yes",
	        peg$c33 = { type: "literal", value: "yes", description: "\"yes\"" },
	        ...
	        peg$c41 = function(values) { return values !== null ? values : []; },
	        peg$c42 = { type: "other", description: "number" },
	        peg$c43 = function() { return parseInt(parseFloat(text().replace("very", "e").replace("VERY", "e")), 8); },
	        peg$c44 = /^[1-7]/,
	        peg$c45 = { type: "class", value: "[1-7]", description: "[1-7]" },
	        peg$c46 = "very",
	        peg$c47 = { type: "literal", value: "very", description: "\"very\"" },
	        peg$c48 = "VERY",
	        peg$c49 = { type: "literal", value: "VERY", description: "\"VERY\"" },
	        peg$c50 = "-",
	        ...
	        peg$c83 = /^[^\0-\x1F"\\]/,
	        peg$c84 = { type: "class", value: "[^\\0-\\x1F\\x22\\x5C]", description: "[^\\0-\\x1F\\x22\\x5C]" },
	        peg$c85 = /^[0-9]/,
	    ...
	    function peg$parseobj_value_separator() {
	      var s0, s1, s2, s3;
	    ...
	    function peg$parseobject() {
	      ...
	      if (s1 !== peg$FAILED) {
	        ...
	        if (s3 !== peg$FAILED) {
	          s4 = [];
	          s5 = peg$currPos;
	          s6 = peg$parseobj_value_separator();
	          if (s6 !== peg$FAILED) {
	            s7 = peg$parsemember();
	            if (s7 !== peg$FAILED) {
	              peg$savedPos = s5;
	...
	module.exports = (function() {
	  ...
	  function peg$parse(input) {
	    var options = arguments.length > 1 ? arguments[1] : {},
	        ...
	        peg$c27 = function(members) { return members !== null ? members: "such wow"; },
